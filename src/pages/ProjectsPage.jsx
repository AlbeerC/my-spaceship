...
export default function ProjectsPage() {
  ...
  return (
    ...
    >
          ...
          >
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-3 bg-slate-900/90 backdrop-blur-sm">
                <h3 className="text-cyan-300 font-mono text-sm font-bold mb-1">
                  {project.codename}
                </h3>
      ...
      {/* 📱 Mobile carousel */}
      <div className="md:hidden flex flex-col justify-center items-center h-full w-full">
        <div className="md:hidden w-full max-w-full px-6 pt-20 overflow-x-auto snap-x snap-mandatory flex space-x-6">
          {projects.map((project, index) => (
            <motion.div
              key={project.id}
          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-6 pb-4 border-b border-cyan-400/30">
                <div>
                  <h2 className="text-cyan-300 font-mono text-2xl font-bold">
                ...
                <div className="flex items-center space-x-3">
                  <motion.div
                    className={`px-3 py-1 rounded-full border font-mono text-xs ${getStatusColor(
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <h3 className="text-purple-300 font-mono text-lg font-bold">
                    VISUAL INTERFACE
                  </h3>
                  ...
                  <div className="flex space-x-3">
                    {currentProject.missionData.liveDemo && (
                      <motion.a
                        ...
                        target="_blank"
                        className="flex-1 bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-400/50 rounded-lg px-4 py-2 text-green-300 font-mono text-sm text-center hover:from-green-500/30 hover:to-emerald-500/30"
                    ...
                    {currentProject.missionData.repository && (
                      <motion.a
                        ...
                        target="_blank"
                        className="flex-1 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-400/50 rounded-lg px-4 py-2 text-blue-300 font-mono text-sm text-center hover:from-blue-500/30 hover:to-cyan-500/30"
                        whileHover={{ scale: 1.02 }}
                        whileTap={{ scale: 0.98 }}
                      >
                        📡 ACCESS CODE
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-slate-800/50 rounded-lg p-3 border border-slate-600/30">
                      ...
                      <p className="text-cyan-300 font-mono text-sm">
                        {currentProject.missionData.duration}
                      </p>
                    </div>
                    <div className="bg-slate-800/50 rounded-lg p-3 border border-slate-600/30">
                      <p className="text-slate-400 font-mono text-xs">
                      ...
                      <p
                        className={`font-mono text-sm ${getComplexityColor(
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {currentProject.missionData.technologies.map(
                        (tech, index) => (
                          <motion.span
                            key={tech}
                  ...
                  <div>
                    ...
                    <p className="text-slate-300 text-sm leading-relaxed">
                      {currentProject.missionData.description}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {currentProject.missionData.objectives.map(
                        (objective, index) => (
                          <motion.div
                            key={index}
